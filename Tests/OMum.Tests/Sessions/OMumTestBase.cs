...
namespace OMum.Tests.Sessions
{
    public abstract class OMumTestBase : AbpIntegratedTestBase
    {
        protected OMumTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<OMumApplicationModule>();
            modules.Add<OMumDataModule>();
        }

        public void UsingDbContext(Action<OMumDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<OMumDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<OMumDbContext, T> func)
        {
            T result;
